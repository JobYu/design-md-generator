...
This product's website is a clean, trustworthy crypto platform that communicates financial reliability through a blue-and-white binary palette. The design uses Brand Blue (`#0052ff`) — a deep, saturated blue — as the singular brand accent against white and near-black surfaces. The proprietary font family includes CoinbaseDisplay for hero headlines, CoinbaseSans for UI text, CoinbaseText for body reading, and CoinbaseIcons for iconography — a comprehensive four-font system.
...
**Key Characteristics:**
- Brand Blue (`#0052ff`) as singular brand accent
...
### Primary
- **Brand Blue** (`#0052ff`): Primary brand, links, CTA borders
...
### Do
- Use Brand Blue (#0052ff) for primary interactive elements
