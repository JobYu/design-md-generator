...
### Primary
- **Brand Dark** (`#191c1f`): Primary dark surface, button background, near-black text
...
### Brand / Interactive
- **Brand Blue** (`#494fdf`): `--rui-color-blue`, primary brand blue
...
| Level | Treatment | Use |
|-------|-----------|-----|
| Flat (Level 0) | No shadow | Everything — Brand uses zero shadows |
| Focus | `0 0 0 0.125rem` ring | Accessibility focus |

**Shadow Philosophy**: Brand uses ZERO shadows. Depth comes entirely from the dark/light section contrast and the generous whitespace between elements.
...
### Don't
- Don't use shadows — Brand is flat by design
...
- Dark: Brand Dark (`#191c1f`)
- Light: White (`#ffffff`)
- Surface: Light (`#f4f4f4`)
- Blue: Brand Blue (`#494fdf`)
- Danger: Red (`#e23b4a`)
- Success: Teal (`#00a87e`)
...
3. Zero shadows — flat is the Brand identity
