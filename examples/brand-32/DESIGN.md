...
- The Brand llama as the sole illustration — black line art, no color
...
### Gradient System
- **None.** Brand uses absolutely no gradients. Visual separation comes from flat color blocks and single-pixel borders. This is a deliberate, almost philosophical design choice.
...
- Logo: Brand llama icon + wordmark in black
...
### Image Treatment
- The Brand llama mascot is the only illustration — black line art on white
...
- Monospace code showing `Brand run` commands
...
- **Content density is low by design**: Where other AI companies pack feature after feature, Brand presents three ideas (run models, use with apps, integrations) and stops.
...
- "Design a navigation bar: transparent background, no border. Brand logo on the left, 3 text links (Pure Black, 16px, weight 400), pill search input in the center, 'Sign in' text link and black pill 'Download' button on the right."
