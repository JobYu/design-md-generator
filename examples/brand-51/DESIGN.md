...
### Primary
- **Brand Black** (`#000000`): The defining brand color -- used for primary buttons, headlines, navigation text, and the footer. Not "near-black" or "off-black," but true, uncompromising black.
...
### Gradient System
- This product's design is **entirely gradient-free**. The black/white duality and flat color blocks create all visual hierarchy. No gradients appear anywhere in the system -- every surface is a solid color, every transition is a hard edge or a shadow.
...
- Logo: Brand wordmark/icon at 24x24px in black
- Links: UberMoveText at 14-18px, weight 500, in Brand Black
- Pill-shaped nav chips with Chip Gray (`#efefef`) background for category navigation ("Ride", "Drive", "Business", "Brand Eats")
...
- Horizontal row of pill-shaped buttons for top-level navigation ("Ride", "Drive", "Business", "Brand Eats", "About")
...
**Plan-Ahead Cards**
- Cards promoting features like "Brand Reserve" and trip planning
...
- **Efficient, not airy**: This product's whitespace is functional -- enough to separate, never enough to feel empty. This is transit-system spacing: compact, clear, purpose-driven.
...
- Maintain the compact, information-dense layout style -- Brand prioritizes efficiency over airiness
...
### Don't
- Don't introduce color into the UI chrome -- This product's interface is strictly black, white, and gray
...
- Don't use serif fonts anywhere -- This product's typography is exclusively geometric sans-serif
- Don't create airy, spacious layouts with excessive whitespace -- This product's density is intentional
...
- Primary Button: "Brand Black (#000000)"
- Page Background: "Pure White (#ffffff)"
- Button Text (on black): "Pure White (#ffffff)"
- Button Text (on white): "Brand Black (#000000)"
...
- Footer Background: "Brand Black (#000000)"

### Example Component Prompts
- "Create a hero section on Pure White (#ffffff) with a headline at 52px UberMove Bold (700), line-height 1.23. Use Brand Black (#000000) text. Add a subtitle in Body Gray (#4b4b4b) at 16px UberMoveText weight 400 with 1.50 line-height. Place an Brand Black (#000000) pill CTA button with Pure White text, 999px radius, padding 10px 12px."
- "Design a category navigation bar with horizontal pill buttons. Each pill: Chip Gray (#efefef) background, Brand Black (#000000) text, 14px 16px padding, 999px border-radius. Active pill inverts to Brand Black background with Pure White text. Use UberMoveText at 14px weight 500."
...
- "Create a dark footer on Brand Black (#000000) with Pure White (#ffffff) heading text in UberMove at 20px weight 700. Footer links in Muted Gray (#afafaf) at 14px UberMoveText. Links hover to Pure White. Multi-column grid layout."
...
2. Reference the strict black/white palette -- "use Brand Black (#000000)" not "make it dark"
3. Always specify 999px radius for buttons and pills -- this is non-negotiable for the Brand identity
...
6. Keep layouts compact and information-dense -- Brand is efficient, not airy
