...
Brand Sans, the brand's custom geometric display typeface designed by Mark Davis, is the visual centerpiece. Letters are intentionally spaced extremely close at large sizes, creating dense, architectural headlines that feel like they're carved into the page. At 64px and 48px, Brand Sans headings sit at weight 600 with a tight 1.10 line-height — confident, compressed, and immediately recognizable. For body text, the system switches to Inter, providing "rock-solid" readability that complements Brand Sans's display personality. The typography pairing creates a clear division: Brand Sans speaks, Inter explains.
...
- Brand Sans custom geometric display font with extremely tight default letter-spacing
- Multi-layered shadow system (11 definitions) with ring borders + diffused shadows + inset highlights
- Brand Sans for headings, Inter for body — clean typographic division
...
### Font Family
- **Display**: `Brand Sans` — custom geometric sans-serif by Mark Davis. Open-source, available on Google Fonts and GitHub. Extremely tight default letter-spacing designed for large headlines. Has 6 character variants (Cc, j, t, u, 0, 1)
- **Body**: `Inter` — "rock-solid" standard body font. Fallback: `Inter Placeholder`
- **UI Light**: `Brand Sans UI Variable Light` — light-weight variant (300) for softer UI text with -0.2px letter-spacing
- **UI Medium**: `Brand Sans UI Medium` — medium-weight variant (500) for emphasized captions
...
|------|------|------|--------|-------------|----------------|-------|
| Display Hero | Brand Sans | 64px | 600 | 1.10 | 0px | Maximum impact, tight default spacing |
| Section Heading | Brand Sans | 48px | 600 | 1.10 | 0px | Large section titles |
| Feature Heading | Brand Sans | 24px | 600 | 1.30 | 0px | Feature block headlines |
| Sub-heading | Brand Sans | 20px | 600 | 1.20 | +0.2px | Positive spacing for readability at smaller size |
| Sub-heading Alt | Brand Sans | 20px | 600 | 1.50 | 0px | Relaxed line-height variant |
| Card Title | Brand Sans | 16px | 600 | 1.10 | 0px | Smallest Brand Sans usage |
| Caption Label | Brand Sans | 12px | 600 | 1.50 | 0px | Small labels in Brand Sans |
| Body Light | Brand Sans UI Light | 18px | 300 | 1.30 | -0.2px | Light-weight body intro text |
| Body Light Standard | Brand Sans UI Light | 16px | 300 | 1.50 | -0.2px | Light-weight body text |
| Caption Light | Brand Sans UI Light | 14px | 300 | 1.40–1.50 | -0.2 to -0.28px | Light captions and descriptions |
...
### Principles
- **Brand Sans at large, Inter at small**: Brand Sans is exclusively for headings and display — never for body text. The system enforces this division strictly
- **Tight by default, space when small**: Brand Sans letters are "intentionally spaced to be extremely close" at large sizes. At 20px and below, positive letter-spacing (+0.2px) must be applied to prevent cramming
- **Weight 300 body variant**: Brand Sans UI Variable Light at 300 weight creates an elegant, airy body text that contrasts with the dense 600-weight headlines
- **Weight 600 dominance**: Nearly all Brand Sans usage is at weight 600 (semi-bold) — the font was designed to perform at this weight
- **Negative tracking on light text**: Brand Sans UI Light uses -0.2px to -0.28px letter-spacing, subtly tightening the already-compact letterforms
...
### Navigation
- **Top nav**: White/transparent background, Brand Sans links at near-black
...
- **Centered headlines**: Brand Sans headings centered with generous margins above and below
...
### Do
- Use Brand Sans exclusively for headings (24px+) and never for body text — it's a display font with tight default spacing
- Apply positive letter-spacing (+0.2px) when using Brand Sans below 24px — the font cramps at small sizes without it
...
- Use Inter for all body text at weight 300–600 — it's the reliable counterpart to Brand Sans's display personality
...
### Don't
- Use Brand Sans for body text or text below 16px — it wasn't designed for extended reading
...
- Apply negative letter-spacing to Brand Sans at small sizes — it needs positive spacing (+0.2px) below 24px
...
- Mix Brand Sans weights — the font is designed for weight 600, other weights break the intended character
...
- **Hero**: 64px Brand Sans display → ~36px on mobile
...
- "Create a hero section with white background, 64px Brand Sans heading at weight 600, line-height 1.10, #242424 text, centered layout with a dark CTA button (#242424, 8px radius, white text)"
...
- "Design a feature section with 48px Brand Sans heading (weight 600, #242424), 16px Inter body text (weight 300, #898989, line-height 1.50), and a product screenshot with 12px radius and the card shadow"

### Iteration Guide
When refining existing screens generated with this design system:
1. Verify headings use Brand Sans at weight 600, body uses Inter — never mix them
