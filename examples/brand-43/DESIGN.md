...
### Accent Colors
- **Brand Purple** (`#6a5fc1`): Primary interactive color — links, hover states, focus rings
...
- **Hover**: color transitions to `#6a5fc1` (Brand Purple)
...
- White text, hover to Brand Purple (`#6a5fc1`)
