...
- Dashed focus outlines echoing This product's editor selection handles
...
*Note: This product's marketing site uses ONLY these two colors for its interface layer. All vibrant colors appear exclusively in product screenshots, hero gradients, and embedded content.*
...
- Each tab represents a Brand product area (Design, Dev Mode, Prototyping, etc.)
...
- References the selection handles in the Brand editor
...
**Shadow Philosophy**: Brand uses shadows sparingly. The primary depth mechanisms are **background contrast** (white content on colorful/dark sections) and the inherent dimensionality of the product screenshots themselves.
